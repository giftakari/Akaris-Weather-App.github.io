...
weatherConditions.onload = function() {
    if (weatherConditions.status === 200){
        ...
        document.getElementById('temperature').innerHTML =`${cObj.main.temp}&degF`;
...
if (weatherForecast.status === 200){
    ...
    date_raw =date_raw.substring(0,11);
...
document.getElementById('r1c3').innerHTML =`${fObj.list[0].main.temp_min} &degF`;
document.getElementById('r1c4').innerHTML = `${fObj.list[0].main.temp_max} &degF`;
...
document.getElementById('r2c3').innerHTML =`${fObj.list[8].main.temp_min} &degF`;
document.getElementById('r2c4').innerHTML = `${fObj.list[8].main.temp_max} &degF`;
...
document.getElementById('r3c3').innerHTML =`${fObj.list[16].main.temp_min} &degF`;
document.getElementById('r3c4').innerHTML = `${fObj.list[16].main.temp_max} &degF`;
